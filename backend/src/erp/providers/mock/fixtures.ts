...
export const MOCK_RAW_PRODUCTS: Array<{
    externalId: string;
    raw: MockRawProduct;
}> = [
    {
    ...
    {
        externalId: "ERP-PROD-002",
        raw: {
            codigo: "ERP-PROD-002",
            descricao: "Blusa Cropped Canelada",
            categoria: "Blusas",
            precoVenda: 79.9,
            marca: "Bippa",
            referencia: "BCC-002",
    ...
    [
        {
            ...
            raw: {
                ...
                itens: [
                    {
                        sku: "ERP-PROD-001",
                        nomeProduto: "Vestido Midi Floral",
                        quantidade: 1,
                        precoUnitario: 189.9,
                    },
                ],
...
export const MOCK_RAW_CLIENTS: Array<{
    externalId: string;
    raw: MockRawClient;
}> = [
    {
...
export const MOCK_RAW_COMPANIES: Array<{
    externalId: string;
    raw: MockRawCompany;
}> = [
    {
