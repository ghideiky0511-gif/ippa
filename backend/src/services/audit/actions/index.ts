...
export const AUDIT_ENTITY_BY_ACTION = {
  ...
  [ORDER_AUDIT_ACTIONS.ITEMS_SEPARATED]: 'order',
  [ORDER_AUDIT_ACTIONS.SELLER_CHANGED]: 'order',
  ...
  [WHATSAPP_INTEGRATION_AUDIT_ACTIONS.TEMPLATE_DELETED]: 'whatsapp_integration',
