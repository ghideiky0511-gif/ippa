...
import { syncStripeOnboardingStatus } from "@/services/payments/stripeOnboardingService";
...
export async function POST(request: NextRequest, context: RouteContext): Promise<Response> {
    ...
    return execute(() => syncStripeOnboardingStatus(route.tenant, authenticated.user));
}
