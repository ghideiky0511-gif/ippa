...
import { fetchMercadoPagoAccountSummary } from "@/services/payments/mercadoPagoOnboardingService";
...
export async function GET(request: NextRequest, context: RouteContext): Promise<Response> {
    ...
    return execute(() => fetchMercadoPagoAccountSummary(route.tenant, authenticated.user));
}
