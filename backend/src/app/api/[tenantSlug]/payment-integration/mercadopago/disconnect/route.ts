...
import { disconnectMercadoPagoAccount } from "@/services/payments/mercadoPagoOnboardingService";
...
export async function POST(request: NextRequest, context: RouteContext): Promise<Response> {
    ...
    return execute(() => disconnectMercadoPagoAccount(route.tenant, authenticated.user, {
