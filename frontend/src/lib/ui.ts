...
export const publicUi = {
  ...
  catalogTabs: 'sticky top-16 z-10 -mx-4 mb-6 flex items-end gap-5 overflow-x-auto border-b border-border bg-surface-muted/90 px-4 pt-3 backdrop-blur-xl [scrollbar-width:none] md:mx-0 md:px-0 [&::-webkit-scrollbar]:hidden',
