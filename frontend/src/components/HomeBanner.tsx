    ...
    return (
        <header className="relative h-full w-full overflow-hidden bg-linear-to-br from-brand-primary to-brand-primary-dark text-white">
            ...
            {banners.length > 1 && (
                <>
                    <button
                        className={`${publicUi.carouselControl} absolute top-1/2 left-3.5 -translate-y-1/2`}
                    ...
                    <button
                        className={`${publicUi.carouselControl} absolute top-1/2 right-3.5 -translate-y-1/2`}
