...
// Extraído de CustomersApp.tsx para ser reaproveitado também pela aba
// "Clientes" do hub de CRM (CrmApp.tsx) sem duplicar a lógica de busca,
// paginação e importação por documento.
...
export default function ClientsPanel({ initialPage }: { initialPage: ClientsPage }) {
