...
export default async function Page() {
        ...
        return (
            <main className="grid min-h-screen place-items-center bg-[#18181b] px-6 text-white">
                <section className="max-w-xl text-center">
                    <p className="mb-6 text-sm font-semibold tracking-[0.28em] text-zinc-400">
                        IPPA
                    </p>
                    <h1 className="font-editorial text-5xl leading-none sm:text-6xl">
    ...
    const rawSections = await backendJson(
        "/api/home-sections",
        z.array(HomeSectionSchema),
        {
