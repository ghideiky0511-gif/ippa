...
Os dois mecanismos coexistem de propósito, e a doc oficial (`typescript.md`) é explícita: *"These type hints do not replace proper validation/sanitization of the input"*.
